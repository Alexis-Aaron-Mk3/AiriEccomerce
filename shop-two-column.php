...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/shop-two-column.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:09:55 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="page-title">Shop 02 Columns</h1>
                        ...
                        <div class="col-12 pt--45 pt-md--35 pt-sm--20 pb--60 pb-md--50 pb-sm--40">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6 text-md-left text-center mb-sm--20">
                                            <div class="shop-toolbar__left">
                                                <p class="product-pages">Showing 1–6 of 42 results</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                            ...
                            <div class="shop-products"> 
                                <div class="row grid-space-30">
                                    <div class="col-md-6 mb--40 mb-md--30">
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="assets/img/products/prod-20-1-568x653.jpg" alt="Product Image" class="primary-image">
                                                            <img src="assets/img/products/prod-20-2-568x653.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="assets/img/products/prod-19-4-568x653.jpg" alt="Product Image" class="primary-image">
                                                            <img src="assets/img/products/prod-19-1-568x653.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="assets/img/products/prod-18-1-568x653.jpg" alt="Product Image" class="primary-image">
                                                            <img src="assets/img/products/prod-18-4-568x653.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="assets/img/products/prod-17-1-568x653.jpg" alt="Product Image" class="primary-image">
                                                            <img src="assets/img/products/prod-17-4-568x653.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="assets/img/products/prod-16-4-568x653.jpg" alt="Product Image" class="primary-image">
                                                            <img src="assets/img/products/prod-16-1-568x653.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
                                        ...
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="product-details.html">
                                                            <img src="assets/img/products/prod-15-1-568x653.jpg" alt="Product Image" class="primary-image">
                                                            <img src="assets/img/products/prod-15-3-568x653.jpg" alt="Product Image" class="secondary-image">
                                                        </a>
                                                    </div>
                                                    <div class="airi-product-action">
                                                        <div class="product-action">
...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/shop-two-column.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:10:11 GMT -->
</html>
<?php
	include "_footer.php";
?>