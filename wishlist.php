...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:10:56 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content" class="main-content-wrapper">
            <div class="page-content-inner enable-page-sidebar pt--45 pb--60 pt-md--35 pb-md--50 pt-sm--25 pb-sm--40">
                <div class="container">
                    <div class="row shop-sidebar">
                        <div class="col-lg-9 order-lg-2 mb-md--30" id="main-content">
                        ...
                        <div class="col-lg-3 order-lg-1" id="primary-sidebar">
                            <div class="sidebar-widget">
                                ...
                                <div class="product-widget categroy-widget">
                                ...
                                <!-- Category Widget Start -->
                                <div class="product-widget tag-widget">
                                    <h3 class="widget-title">Categories</h3>
                                    <div class="tagcloud">
