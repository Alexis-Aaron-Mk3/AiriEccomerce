...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:11:20 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row justify-content-center ptb--100">
                        <div class="col-lg-8 text-center">
                            <div class="error-text">
                                <img src="assets/img/others/404-img.png" alt="404">
                                <h2 class="error-heading mt--20">Page cannot be found!</h2>
                                <p class="mb--40">It looks like nothing was found at this locations.</p>
                                <a href="index.html" class="btn btn-color-gray btn-medium btn-bordered btn-style-1">Back to home</a>
                            </div>
                        </div>
                    </div>
                </div>
