                ...
                <div class="row mb--15 mb-sm--20">
                    ...
                    <div class="col-xl-2 col-md-4 mb-lg--30">
                        <div class="footer-widget">
                            ...
                            <ul class="widget-menu widget-menu--2">
                                <li><a href="Shop Collections">The Collections</a></li>
                ...
                <div class="side-navigation-inner">
                    <div class="widget">
                        <ul class="sidenav-menu">
                            <li><a href="about-us.php">About Airi Shop</a></li>
                            <li><a href="about-us.php">Help Center</a></li>
                            <li><a href="shop-collections.php">Portfolio</a></li>
                            <li><a href="blog.php">Blog</a></li>
                            <li><a href="shop-instagram.php">New Look</a></li>
                        </ul>
                    </div>
                ...
                <div class="mini-cart-inner">
                    ...
                    <div class="mini-cart__content">
                        ...
                        <div class="mini-cart__buttons">
                            <a href="cart.php" class="btn btn-fullwidth btn-style-1">View Cart</a>
                            <a href="checkout.php" class="btn btn-fullwidth btn-style-1">Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="modal-box product-summary">
                            ...
                            <div class="product-action d-flex flex-row align-items-center mb--30 mb-md--20">
                                ...
                                <button type="button" class="btn btn-style-1 btn-semi-large add-to-cart" onclick="window.location.href='cart.php'">
                                    Add To Cart
                                </button>
                            ...
                            <div class="product-summary-footer d-flex justify-content-between flex-sm-row flex-column flex-sm-row flex-column">
                                <div class="product-meta">
                                    ...
                                    <span class="posted_in font-size-12">Categories: <a href="shop-sidebar.php" rel="tag">Fashions</a></span>
                                </div>
...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:10:55 GMT -->
</html>