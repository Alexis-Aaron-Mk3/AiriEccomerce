...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/product-details-configurable.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:10:53 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <form action="#" class="variation-form mb--35">
                                    ...
                                    <div class="product-size-variations">
                                        ...
                                        <div class="product-size-swatch variation-wrapper">
                                            <div class="swatch-wrapper">
                                                <a class="product-size-swatch-btn variation-btn" data-toggle="tooltip" data-placement="top" title="L">
                                                    <span class="product-size-swatch-label">L</span>
                                                </a>
                                            </div>
                                            <div class="swatch-wrapper">
                                                <a class="product-size-swatch-btn variation-btn" data-toggle="tooltip" data-placement="top" title="M">
                                                    <span class="product-size-swatch-label">M</span>
                                                </a>
                                            </div>
                                            <div class="swatch-wrapper">
                                                <a class="product-size-swatch-btn variation-btn" data-toggle="tooltip" data-placement="top" title="S">
                                                    <span class="product-size-swatch-label">S</span>
                                                </a>
                                            </div>
                                            <div class="swatch-wrapper">
                                                <a class="product-size-swatch-btn variation-btn" data-toggle="tooltip" data-placement="top" title="XL">
                                                    <span class="product-size-swatch-label">XL</span>
                                                </a>
                                            </div>
                                            <div class="swatch-wrapper">
                                                <a class="product-size-swatch-btn variation-btn" data-toggle="tooltip" data-placement="top" title="XXL">
