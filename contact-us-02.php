...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/contact-us-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:11:20 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="container">
                    <div class="row pt--70 pt-md--50 pt-sm--35 pb--80 pb-md--60 pb-sm--40">
                        <div class="col-md-7 offset-xl-1 order-md-2 mb-sm--30">
                            <h3 class="text-center font-size-md-25 font-size-sm-20">Let us know what you have in mind, and we'll get back to you in an instant!</h3>
                            ...
                            <form class="form" action="http://demo.hasthemes.com/airiV-2/airi/mail.php" id="contact-form">
