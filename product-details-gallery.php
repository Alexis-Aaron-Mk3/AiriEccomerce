...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/product-details-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:10:36 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="current"><span>Product Details Gallery</span></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div id="content" class="main-content-wrapper">
            <div class="page-content-inner enable-full-width">
                <div class="container-fluid">
                                            ...
                                            <div class="row grid-space-10">
                                                <div class="col-12 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="assets/img/products/prod-15-4.jpg" alt="Product">
                                                    </figure>
                                                </div>
                                                <div class="col-6 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="assets/img/products/prod-15-3-1.jpg" alt="Product">
                                                    </figure>
                                                </div>
                                                <div class="col-6 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="assets/img/products/prod-15-2.jpg" alt="Product">
                                                    </figure>
                                                </div>
                                                <div class="col-12 mb--10">
                                                    <figure class="product-gallery__image">
                                                        <img src="assets/img/products/prod-15-6.jpg" alt="Product">
                                                    </figure>
                                                </div>
                                            </div>
                                    ...
                                    <div class="product-color-variations">
                                        ...
                                        <div class="product-color-swatch variation-wrapper">
                                            <div class="swatch-wrapper">
                                                <a class="product-color-swatch-btn variation-btn blue" data-toggle="tooltip" data-placement="top" title="Blue">
                                                    <span class="product-color-swatch-label">Blue</span>
                                                </a>
                                            </div>
                                            <div class="swatch-wrapper">
                                                <a class="product-color-swatch-btn variation-btn green" data-toggle="tooltip" data-placement="top" title="Green">
                                                    <span class="product-color-swatch-label">Green</span>
                                                </a>
                                            </div>
                                            <div class="swatch-wrapper">
                                                <a class="product-color-swatch-btn variation-btn pink" data-toggle="tooltip" data-placement="top" title="Pink">
                                                    <span class="product-color-swatch-label">Pink</span>
                                                </a>
                                            </div>
                                            <div class="swatch-wrapper">
                                                <a class="product-color-swatch-btn variation-btn red" data-toggle="tooltip" data-placement="top" title="Red">
                                                    <span class="product-color-swatch-label">Red</span>
                                                </a>
                                            </div>
                                            <div class="swatch-wrapper">
                                                <a class="product-color-swatch-btn variation-btn white" data-toggle="tooltip" data-placement="top" title="White">
                    ...
                    <div class="row justify-content-center pt--65 pt-md--45 pt-sm--35">
                        <div class="col-12">
...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/product-details-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:10:52 GMT -->
</html>
<?php
	include "_footer.php";
?>