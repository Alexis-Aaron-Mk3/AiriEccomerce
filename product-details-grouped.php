...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/product-details-grouped.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:10:52 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="current"><span>Product Grouped</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row pt--40">
                        ...
                        <div class="col-md-6 product-main-details mt--40 mt-md--10 mt-sm--30">
                            <div class="product-summary">
                                ...
                                <h3 class="product-title">Product Grouped</h3>
                                        ...
                                        <table class="table group-product-table">
                                            <tr>
                                                <td class="product-quantity">
                                                    <div class="quantity">
                                                        <input type="number" class="quantity-input" name="qty" id="qty-1" value="0" min="0">
                                                    </div>
                                                </td>
                                                <td class="product-name">
                                                    <h3><a href="product-details.html">Limited edition v-neck t-shirt</a></h3>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="product-quantity">
                                                    <div class="quantity">
                                                        <input type="number" class="quantity-input" name="qty" id="qty-2" value="0" min="0">
                                                    </div>
                                                </td>
                                                <td class="product-name">
                                                    <h3><a href="product-details.html">Waxed-effect pleated skirt</a></h3>
                                                </td>
                                                <td class="product-price">
                                                    <div class="product-price-wrapper">
                                                        <span class="money">$49.00</span>
                                            ...
                                            <tr>
                                                <td class="product-quantity">
                                                    <div class="quantity">
                                                        <input type="number" class="quantity-input" name="qty" id="qty-3" value="0" min="0">
                                                    </div>
                                                </td>
                                                <td class="product-name">
                                                    <h3><a href="product-details.html">Chain print bermuda shorts</a></h3>
                                                </td>
                                                <td class="product-price">
                                                    <div class="product-price-wrapper">
                                                        <span class="money">$49.00</span>
