...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/product-details-sticky.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:10:25 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="current"><span>Product Details Sticky</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="page-content-inner enable-full-width">
                <div class="container-fluid">
                    <div class="row pt--40">
                                ...
                                <div class="product-gallery">
                                    <div class="product-gallery__large-image">
                                        <figure class="product-gallery__image mb--10">
                                            <img src="assets/img/products/prod-18-1-big.jpg" alt="Product">
                                        </figure>
                                        <figure class="product-gallery__image mb--10">
                                            <img src="assets/img/products/prod-18-4-big.jpg" alt="Product">
                                        </figure>
                                        <figure class="product-gallery__image mb--10">
                                            <img src="assets/img/products/prod-18-2.jpg" alt="Product">
                                        </figure>
                                        <figure class="product-gallery__image mb--10">
                                            <img src="assets/img/products/prod-18-3.jpg" alt="Product">
                                        </figure>
                        ...
                        <div class="col-md-6 product-main-details" id="sticky-sidebar">
                    ...
                    <div class="row justify-content-center pt--75 pt-md--55 pt-sm--35">
                        <div class="col-12">
...
<!-- Mirrored from demo.hasthemes.com/airiV-2/airi/product-details-sticky.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 15:10:36 GMT -->
</html>
<?php
	include "_footer.php";
?>